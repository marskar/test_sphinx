...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"test_sphinx","description":"Use Python, Pypandoc, and Pandoc to create HTML slides from source files."}'
	test -f README.rst || echo "test_sphinx" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/test_sphinx.git
